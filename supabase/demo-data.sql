...
insert into teachers (teacher_code, full_name, short_name, is_open_teacher, primary_subject_id) values
  ...
  -- T04..T08 are the genuinely light-loaded teachers (14-17 periods/week),
-- so they are flagged as open teachers (always eligible as substitutes).
  ('T04', 'James William',          'Mr. William', true, (select id from subjects where short_name='Eng')),
  ('T05', 'Sabina Yasmin',          'Mrs. Sabina', true, (select id from subjects where short_name='Eng')),
  ('T06', 'Christina Gomes',        'Ms. Christina',true,(select id from subjects where short_name='Eng')),
  ('T07', 'Moniruzzaman',           'Mr. Monir',   true, (select id from subjects where short_name='Math')),
  ('T08', 'Shahana Parvin',         'Mrs. Shahana',true,(select id from subjects where short_name='Math')),
